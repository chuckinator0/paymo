...
with open('../paymo_input/batch_payment.csv','r', errors = 'ignore') as batch_payment:
    data = csv.DictReader(batch_payment)
...
# Run Feature 1
k = 1
outfile = open('../paymo_ouput/output1.txt', "w")
with open('../paymo_input/stream_payment.csv','r', errors = 'ignore') as streamCSV:
...
# Run Feature 2
k = 2
outfile = open('../paymo_ouput/output2.txt', "w")
with open('../paymo_input/stream_payment.csv','r', errors = 'ignore') as streamCSV:
    stream = csv.DictReader(streamCSV)
    for row in stream:
        id1 = int(row[' id1'])
...
# Run Feature 3
k = 3
outfile = open('../paymo_ouput/output3.txt', "w")
with open('../paymo_input/stream_payment.csv','r', errors = 'ignore') as streamCSV:
    stream = csv.DictReader(streamCSV)
    for row in stream:
        id1 = int(row[' id1'])
